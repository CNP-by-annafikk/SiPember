            ...
            <>
                <div className="min-h-screen flex flex-grow items-center justify-center bg-gray-50">
                    <div className="rounded-lg bg-white p-8 text-center shadow-xl">
                        ...
                        <p className="text-gray-600 text-3xl"><b>Accepted</b></p><br />
                        <p className="text-gray-600">Oops! Halaman yang Anda cari masih dalam pengembangan.</p>
                        {this.state.apiResponse ? (
                            <p className="App-intro text-gray-600">Note: {this.state.apiResponse}</p>
                        ) : (
                            <p className="App-intro text-gray-600">Note: API Tidak Terkoneksi</p>
                        )}
                        <br />
